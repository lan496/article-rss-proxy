...
`src/main.py` orchestrates three independent pipelines (arXiv, APS, Nature), selectable via `--pipeline`.
...
- **Output**: `docs/arxiv.xml`, `docs/aps-*.xml`, `docs/nature-*.xml` (gitignored; deployed to `gh-pages` branch by CI)
